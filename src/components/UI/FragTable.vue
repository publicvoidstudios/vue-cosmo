...
export default {
  ...
  methods: {
    ...
    async updateReviewApproval(id, approved) {
      try {
        const response = await fetch('/api/update-review-approval', {
          method: 'PUT',
          headers: {
            'Content-Type': 'application/json'
          },
    ...
    async modifySection(id, name, html_id, img_url) {
      try {
        const response = await fetch('/api/modify-section', {
          method: 'PUT',
          headers: {
            'Content-Type': 'application/json'
          },
    ...
    async modifySubsection(id, parent_section_name, subsection_name, html_id, img_url) {
      try {
        const response = await fetch('/api/modify-subsection', {
          method: 'PUT',
          headers: {
            'Content-Type': 'application/json'
          },
    ...
    async modifyService(id, name, html_id, description, img_url) {
      try {
        const response = await fetch('/api/modify-service', {
          method: 'PUT',
          headers: {
            'Content-Type': 'application/json'
          },
    ...
    async modifyCourse(id, name, html_id, description, img_url, medical) {
      try {
        const response = await fetch('/api/modify-course', {
          method: 'PUT',
          headers: {
            'Content-Type': 'application/json'
          },
    ...
    async modifyArticle(id, title, body, author) {
      try {
        const response = await fetch('/api/modify-article', {
          method: 'PUT',
          headers: {
            'Content-Type': 'application/json'
          },
